...
public class HelloController{
    ...
    private MediaPlayer mediaPlayerInformation;
    @FXML
    ...
    public void initialize() {
        ...
        URL mediaUrl = getClass().getResource("/com/example/demo/error.mp3");
        Media mediaError = new Media(mediaUrl.toExternalForm());
        mediaPlayerError = new MediaPlayer(mediaError);

        URL mediaUrl1 = getClass().getResource("/com/example/demo/information.mp3");
        Media mediaInformation = new Media(mediaUrl1.toExternalForm());
        mediaPlayerInformation = new MediaPlayer(mediaInformation);

        URL mediaUrl2 = getClass().getResource("/com/example/demo/warning.mp3");
        Media mediaWarning = new Media(mediaUrl2.toExternalForm());
        mediaPlayerWarning = new MediaPlayer(mediaWarning);
    ...
    private void handlebtnComprarAction() {
        ...
        if (subtotalPapaValue == 0 && subtotalCarneValue == 0 && subtotalPolloValue == 0 && subtotalVegetalesValue == 0) {
            ...
            mediaPlayerWarning.stop();
            mediaPlayerWarning.play();
            alert.show();
            return;
        }
        ...
        mediaPlayerInformation.stop();
        mediaPlayerInformation.play();
        alert.show();
    }
